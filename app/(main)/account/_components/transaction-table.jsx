...
export function TransactionTable({ transactions }) {
    ...
    return (
        <div className="space-y-4 xxs:space-y-5 sm:space-y-6">
            ...
            {totalPages > 1 && (
                <div className="flex items-center justify-center gap-3 xxs:gap-4 mt-4 xxs:mt-5 sm:mt-6">
                    <Button
                        variant="outline"
                        size="icon"
                    ...
                    >
                        <ChevronLeft className="h-4 xxs:h-5 w-4 xxs:w-5" />
                    </Button>
                    <span className="text-xs xxs:text-sm font-semibold text-orange-900 dark:text-orange-100">
                    ...
                    >
                        <ChevronRight className="h-4 xxs:h-5 w-4 xxs:w-5" />
                    </Button>
                </div>
            )}
        </div>
